...
const About = () => {
  return (
    <section className="relative min-h-screen py-34" id="about">
        ...
        <div className="grid items-center justify-start w-full grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <div className="inline-flex flex-col items-center justify-center w-full gap-10 lg:items-start">
            <div className="flex flex-col items-start justify-center w-full gap-8">
              ...
              >
                <h2 className="text-4xl font-bold leading-normal text-center text-gray-900 font-title lg:text-start">
                  Hi, Ade Setiyawan Saya Photographer Profesional
                </h2>
                <p className="text-base leading-relaxed text-center text-gray-500 font-title lg:text-start">
                  Growing up, I always had a passion for photography. I loved
                  the way that seemingly mundane moments could be captured and
                  transformed into true beauty. This notion still captivates me,
                  and pushes my creativity every day. If you’d like to learn
                  more about me and my work, please do not hesitate to get in
                  touch.
                </p>
              </motion.div>
